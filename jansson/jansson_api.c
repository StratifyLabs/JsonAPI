...
const jansson_api_t jansson_api = {
	...
	.object_getn = json_object_getn,
	.object_setn = json_object_setn,
	//.object_set_new_nocheck = json_object_set_new_nocheck,
	.object_deln = json_object_deln,
	...
	.object_update_missing = json_object_update_missing,
        .object_update_new = json_object_update_new,
        .object_update_existing_new = json_object_update_existing_new,
        .object_update_missing_new = json_object_update_missing_new,
        .object_update_recursive = json_object_update_recursive,
